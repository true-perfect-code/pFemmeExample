...
namespace pFemmeExample.Web.Apis
{
    ...
    public static class Endpoints
    {
        ...
        public static void SetPepper(this WebApplication app)
        {
            ...
            //var _globalState = scope.ServiceProvider.GetRequiredService<pFemmeExample.Shared.Services.GlobalState.IGlobalState>();
            //var _appState = scope.ServiceProvider.GetRequiredService<pFemmeExample.Shared.Services.AppState.IAppState>();
        ...
        public static void MapEndPoints(this WebApplication app)
        {
            ...
            app.MapPost("/api/logout", async (HttpContext context, IAuthenticationBase auth, HttpClient httpClient, IGlobalStateBase _globalState) =>
            {
