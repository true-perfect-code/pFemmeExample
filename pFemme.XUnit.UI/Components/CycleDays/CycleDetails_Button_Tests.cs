...
namespace pFemmeExample.XUnit.UI.Components.CycleDays
{
    public class CycleDetails_Button_Tests : IDisposable
    {
        ...
        public CycleDetails_Button_Tests()
        {
            ...
            _appState.InitializeUnixTSDeviceId("test_device_ui_cycledays");
        ...
        [Fact]
        public async Task CycleDays_RendersWithoutCrash()
        {
            ...
            var exception = Record.Exception(() => ctx.Render<pFemmeExample.Shared.Pages.Components.CycleDays>());
            Assert.Null(exception);
        }

        [Fact]
        public async Task CycleDays_Click_OpensModal()
        {
            await CreateTestData();
            ...
            var cut = ctx.Render<pFemmeExample.Shared.Pages.Components.CycleDays>();

            var component = cut.Instance;

            // Button über ID finden (statt AriaLabel)
            var button = cut.Find("#detailsButton");
