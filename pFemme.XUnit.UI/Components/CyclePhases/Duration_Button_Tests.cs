...
{
    public class Duration_Button_Tests : IDisposable
    {
        ...
        public Duration_Button_Tests()
        {
            ...
            _appState.InitializeUnixTSDeviceId("test_device_ui_duration");
        ...
        [Fact]
        public async Task Duration_RendersWithoutCrash()
        {
        ...
        [Fact]
        public async Task Duration_Click_OpensModal()
        {
            await CreateTestData();
            ...
            // Button über ID finden (statt über Index)
            var button = cut.Find("#durationButton");
            Assert.NotNull(button);
            await button.ClickAsync();

            // Modal-ID als String
            var modalId = component.ModalId2.ToString();
