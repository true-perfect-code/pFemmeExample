...
/// <summary>
/// Local JSON_HYBRID integration tests for Cycles CRUD operations.
/// Uses real JSON file storage (persistent) via the WPF LocalJsonFile implementation.
/// Files are stored in %LocalAppData%/pFemme/Storage/{UserHash}/Cycles/
/// </summary>
public class CyclesCrudTestsLocalJson : IDisposable
{
    ...
    public CyclesCrudTestsLocalJson()
    {
        // ====================================================================
        // 1. TEST-KONFIGURATION (JSON_HYBRID)
        // ====================================================================
        ...
        // Echte WPF-Implementierung für JSON-Dateien (als Link eingebunden)
        services.AddSingleton<ILocalJsonFile, pFemmeExample.Wpf.Services.LocalJsonFile>();
    ...
    public async Task FullCrudCycle_CyclesTable_WorksCorrectly()
    {
        ...
        var newCycle = new CyclesModel
        {
            ...
            nausea = 0,
            cramps = 2,
            Details = "JSON integration test cycle - created"
        };
        ...
        savedCycle.pain = 4;
        savedCycle.Details = "JSON integration test cycle - updated";
        ...
        Assert.Equal("JSON integration test cycle - updated", updatedCycle?.Details);
