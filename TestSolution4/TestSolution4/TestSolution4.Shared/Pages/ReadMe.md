...
Todo's:
- Falls MSSQL benutzt werden soll, dann in pE >...> GlobalStateBase > GetConnectionString() das Passwort für JSON file [YOUR_PROJECT_NAME].json ermitteln (siehe Beschreibung unter 'aes')
