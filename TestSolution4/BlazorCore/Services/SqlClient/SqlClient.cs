...
namespace BlazorCore.Services.SqlClient
{
    public class SqlClient : ISqlClientBase
    {
        ...
        //public SqlClient(IGlobalStateBase globalState, IAppStateBase appState)
        public SqlClient(IGlobalStateBase globalState)
        {
            ...
            //Scalar resultconnectionstring =  //Json.GetConnectionFile();
            //if (resultconnectionstring.ValString != null && resultconnectionstring.Success)
            //{
            //    string connectionFilePath = resultconnectionstring.ValString;
            //    if (!String.IsNullOrEmpty(connectionFilePath))
            //    {
            //        //connectionString = Appl.ConnectionString;
            //        string err = Appl.SetConnectionString(ref connectionString, ref isConnected, connectionFilePath);
            //        if (!String.IsNullOrEmpty(err))
            //        {
            //            // TODO : Log speichern oder Email an Administrator versenden
            //        }
            //    }
            //}

            //connectionString = (PlatformHelper.GetConnectionString().Success
            //    && PlatformHelper.GetConnectionString().ValString != null
            //    ? PlatformHelper.GetConnectionString().ValString! : "");
            ...
            if (!string.IsNullOrEmpty(basedir))
            {
                ...
                if (parentbasedir != null && parentbasedir.Parent != null)
                {
                    ...
                    if (File.Exists(connectionstringpath))
                    {
                        ...
                        //ConnectionString = _globalState.ReadJson<ConnectionStringModel>(connectionstringpath)!;
...
#pragma warning restore CA1416
        ...
        //                    sppara.Value = _globalState.ConvertStrPara<string>(kvp.Value!).Trim();
        ...
        //                        string[] arrTbl = _globalState.ConvertStrPara<string>(kvp.Value).Trim().Split(">>");
        //                        if (arrTbl.Length > 1)
        ...
        //                                    sppara.Size = _globalState.ConvertStrPara<string>(kvp.Value).Trim().Length;
        //                                    sppara.Value = _globalState.StringToByteArray(_globalState.ConvertStrPara<string>(kvp.Value.Trim()));
        //                                }
        //                                else
        //                                {
        //                                    sppara.Size = tbldef.COL_SIZE;
        //                                    //sppara.Value = ConvertNETtoSQL(tbldef.NET_TYPE, Appl.ConvertStrPara<string>(kvp.Value.mssql).Trim());
        //                                    sppara.Value = ConvertNETtoSQL(tbldef.NET_TYPE, _globalState.ConvertStrPara<string>(kvp.Value).Trim());
        //                                }
        //                            }
        ...
        //                sppara.Value = _globalState.ConvertStrPara<string>(value);
        //                _cmd.Parameters.Add(sppara);
        ...
        //                //    string[] arrTbl = _globalState.ConvertStrPara<string>(value).Split(">>");
        ...
        //                        byte[] byteValue = _globalState.StringToByteArray(_globalState.ConvertStrPara<string>(value));
        ...
        //                    {
        //                        sppara.Size = tbldef.COL_SIZE;
        //                        //sppara.Value = ConvertNETtoSQL(tbldef.NET_TYPE, _globalState.ConvertStrPara<string>(value));
            ...
            try
            {
                foreach (var kvp in _db_para)
                {
                    ...
                    if (key == "@Case_")
                    {
                        ...
                        SqlParameter sppara = new SqlParameter("@Case_", SqlDbType.VarChar, 2000);
                        sppara.Value = _globalState.ConvertStrPara<string>(value);
                        _cmd.Parameters.Add(sppara);
                    }
                    // Behandle alle anderen definierten Parameter
