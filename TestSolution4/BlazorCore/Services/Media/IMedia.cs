...
//        /// </summary>
//        /// <returns>
//        /// A <see cref="Stream"/> containing the selected photo, or <c>null</c> if the user canceled the operation.
//        /// </returns>
...
//        /// </summary>
//        /// <returns>
//        /// A <see cref="Stream"/> containing the selected video, or <c>null</c> if the user canceled the operation.
//        /// </returns>
//        Task<Stream?> PickVideoAsync();

//        /// <summary>
//        /// Opens the device's native camera app for capturing a new photo.
//        /// </summary>
//        /// <returns>
//        /// A <see cref="Stream"/> containing the captured photo, or <c>null</c> if the user canceled the operation.
//        /// </returns>
//        Task<Stream?> CapturePhotoAsync();

//        /// <summary>
//        /// Opens the device's native camera app for capturing a new video.
//        /// </summary>
//        /// <returns>
//        /// A <see cref="Stream"/> containing the captured video, or <c>null</c> if the user canceled the operation.
//        /// </returns>
//        Task<Stream?> CaptureVideoAsync();
//    }
//}
